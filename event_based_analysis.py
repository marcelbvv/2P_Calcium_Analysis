...
def get_event_location(binary, fs, exclusion_window= False, exclusion_time= [-0.5, 0], inactive = [], remove_short= False, min_duration= 0.5, join_bouts= False, max_duration= 1, separate_bins=False, bins=[2, 4, 6]):
...
def check_data(list_files=None, save_path=None):
    ...
    #                 'Negative': {}
    #                 }
    # combined_whisk = {'Total': {},
    #                 'Positive': {},
    #                 'Negative': {}
    #                 }
    # combined_whisk_only = {'Total': {},
    #                        'Positive': {},
    #                        'Negative': {}
    #                        }
    ...
    for file in tqdm(files):
        ...
        if 'pearson_shuffle' in data:
            ...
            # Locomotion
            locomotion_dic = get_event_location(locomotion_binary, fs, 
