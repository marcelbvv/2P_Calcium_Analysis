...
import base_calculation, list_preprocessing, save_session, plot_figures, get_dataRE
...
def define_settings():
    settings = {
            ...
            'red_cells': {'separate':False,
                          'cell_type': 'Green'}, #'Green' and 'Green+Red'
...
def run_Ca_analysis(settings = {}, dataset={}):
    ...
    Combined_aligned_loc = {}
    Combined_aligned_whisk = {}
    Combined_aligned_whisk_only = {}
    Whisker_stimulation = {}
    ...
    for file in range(0,np.size(list_files)):
        ...
        if locomotion_file == []:
            ...
            if 'puff signal' in locomotion:
                if any(val == 1 for val in locomotion['puff signal']):
                    ...
                    print('-- No puff events in whisker stimulation file')
                    pass
    ...
    combined_dic = {'Data table': Combined_Data,
                    ...
                    'Events locomotion': Combined_aligned_loc,
                    'Events whisking': Combined_aligned_whisk,
                    'Events whisking only': Combined_aligned_whisk_only}
    ...
    return combined_dic, save_directory
